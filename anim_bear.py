...
def bear(x, y, r):
    ...
    рисует медведа
    x, y - координаты
    r - размер медведа, в сколько раз уменьшится (r > 1) / увеличится (0 < r < 1)
    '''
...
def anim():
    '''
    анимация галлюцинации медведа
    '''
    for i in range(-600, 600):
        w = i
        rect(sc, blue, (0, 0, 600, 50))
        fish(w, -300, 2)
        rect(sc, blue, (0, 50, 600, 50))
        star()
        fish(w, -200, 2)
        rect(sc, blue, (0, 100, 600, 50))
        star()
        fish(w, -100, 2)
        rect(sc, blue, (0, 150, 600, 50))
        star()
        fish(w, 0, 2)
        rect(sc, blue, (-10, 200, 600, 50))
        star()
        fish(w, 100, 2)
        rect(sc, blue, (0, 250, 600, 50))
        star()
        fish(w, 200, 2)
        rect(sc, blue, (0, 300, 600, 50))
        star()
        fish(w, 300, 2)
        rect(sc, blue, (0, 350, 600, 50))
        fish(w, 400, 2)
        rect(sc, blue, (0, 400, 600, 50))
        fish(w, 500, 2)
        pygame.display.update()
